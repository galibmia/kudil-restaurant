...
const Login = () => {
    ...
    return (
        <div>
            <form className="w-full md:w-1/3 mx-auto mt-32 border border-gray-300 rounded-sm p-4 md:px-14 md:py-14" onSubmit={handleLogin}>
            ...
            <div className='w-full md:w-1/3 mx-auto mt-5'>
                ...
                <button className='w-4/5 mx-auto mt-6 p-2 border border-gray-400 hover:border-gray-700 rounded-3xl flex items-center gap-24'>
                    ...
                    <span className='montserrat-regular text-gray-950 hover:text-gray-900'>Continue with Github</span>
                </button>
                <button onClick={handleLoginWithGoogle} className='w-4/5 mx-auto mt-6 p-2 border border-gray-400 hover:border-gray-700 rounded-3xl flex items-center gap-24'>
                    <FcGoogle className='text-blue-600 text-5xl'></FcGoogle>
                    <span className='montserrat-regular text-gray-950'>Continue with Google</span>
                </button>
            </div>
        </div>
    );
