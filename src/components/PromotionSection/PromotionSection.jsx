  ...
  return (
    <div className="w-[80%] mx-auto my-24">
      <div className="grid grid-cols-2 gap-20">
        <Fade direction="right" duration={1000}> {/* Add animation to the chef image */}
          <div
        ...
        <Fade direction="left" duration={1000}> {/* Add animation to the text section */}
          <div className="py-14 px-8">
            ...
            <ul className="space-y-3">
              <li className="relative pl-8 my-4">
                <span className="absolute left-0 top-1/2 transform -translate-y-1/2 w-3 h-3 border-2 border-red-500 bg-white rounded-full"></span>
            ...
            <div className="mt-16">
              <Link className="px-10 py-6 bg-red-600 text-white transform transition-all duration-300 hover:px-9 hover:py-5 hover:ml-1 hover:bg-yellow-300 hover:text-black">
                Read More
              </Link>
            </div>
          </div>
